...
class GameSetting:
    ...
    talk_on_first_day: bool # 初日の内通OKか
    """Whether or not there are talks on the first day."""
    time_limit: int # リクエストへの応答速度の限界
